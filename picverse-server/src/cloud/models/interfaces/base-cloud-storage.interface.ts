...
export interface IStorageService {
  ...
  getFile(resource: Resource, width?: number, height?: number): Promise<Blob>;
  getFileStream(resource: Resource, response: Response, width?: number, height?: number): Promise<void>;
