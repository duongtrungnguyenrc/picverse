...
const ForgotPasswordForm: FC = () => {
  ...
  const { sessionId, handleForgotPassword, isPending: sendingForgotPassword } = useForgotPassword();
  const { handleResetPassword, isPending: sendingResetPassword } = useResetPassword();
  ...
  const onForgotPassword = forgotPasswordForm.handleSubmit((data) => handleForgotPassword(data));
